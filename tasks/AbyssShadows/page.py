...
page_abyss.connect(page_shikigami_records, AbyssShadowsAssets.I_ABYSS_SHIKI, key="page_abyss->page_shikigami_records", cost=4)
page_shikigami_records.connect(page_abyss, GlobalGameAssets.I_UI_BACK_YELLOW, key="page_shikigami_records->page_abyss", cost=4)
