...
class GlobalGameAssets: 
	...
	# 按住即可返回庭院 
	I_UI_ANY_TO_MAIN = RuleImage(roi_front=(102,14,47,46), roi_back=(0,0,179,91), threshold=0.9, method="Template matching", file="./tasks/GlobalGame/ui/ui_ui_any_to_main.png")
